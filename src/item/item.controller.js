...
router.post('/',adminAuthorization,async(req,res,next)=>{
    try{
...
router.get('/:id',authorizeJWT,async(req,res,next)=>{
    try{
...
router.put('/:id',adminAuthorization,async(req,res,next)=>{
    try{
...
router.delete('/:id',adminAuthorization,async(req,res,next)=>{
    try{
